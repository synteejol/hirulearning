...
class block_cocoon_course_grid_3 extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_cocoon_course_grid_3');
    }
    ...
    public function get_content() {
        ...
        $this->content->text .= '
        <section id="our-top-courses" class="our-courses ccn-courses-grid-block ccn-courses-grid-block-3" data-ccn-c="color_bg" data-ccn-co="bg" style="background-color: '.$this->content->color_bg.';">
          <div class="container">
            <div class="row">
...
';
    ...
    //               FROM {block_cocoon_course_grid_3} fc
    //               JOIN {course} c
    //                 ON (c.id = fc.courseid)
    //           ORDER BY sortorder';
    ...
    //     global $DB;
    //     return $DB->delete_records('block_cocoon_course_grid_3', array('courseid' => $courseid));
    // }
}
