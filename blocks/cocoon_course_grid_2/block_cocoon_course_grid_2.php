...
class block_cocoon_course_grid_2 extends block_base {

    public function init() {
        $this->title = get_string('pluginname', 'block_cocoon_course_grid_2');
    }
    ...
    public function get_content() {
        ...
        if(!empty($this->config->color_btn)){$this->content->color_btn = $this->config->color_btn;} else {$this->content->color_btn = 'rgb(202, 190, 159)';}
                  ...
                  <a href="'. $ccnCourse->url .'"><div class="thumb">
                    ...
                    if($this->content->hover_text){
                     $this->content->text .='<span class="tc_preview_course" data-ccn="hover_text">'.format_text($this->content->hover_text, FORMAT_HTML, array('filter' => true)).'</span>';
                      ...
                      $this->content->text .=  '<h5 data-ccn-c="color_course_title" data-ccn-co="content" style="color: '.$this->content->color_course_title.';">'.$ccnCourse->fullName.'</h5>';
                      if($ccnBlockShowDesc){
...
$this->content->text .='
      ...
      <div class="col-lg-6 offset-lg-3">
        <div class="courses_all_btn text-center">
          <a class="btn btn-transparent" data-ccn-c="color_btn" data-ccn-co="content" data-ccn="button_text" href="'.format_text($this->content->button_link, FORMAT_HTML, array('filter' => true)).'" style="color:'.$this->content->color_btn.'">'.format_text($this->content->button_text, FORMAT_HTML, array('filter' => true)).'</a>
        </div>
      </div></div>'  ;
      }
$this->content->text .='
