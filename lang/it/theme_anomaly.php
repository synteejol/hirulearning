...
/**
 * Strings for component 'theme_anomaly', language 'it', branch 'MOODLE_31_STABLE'
 *
...
$string['customcssdesc'] = 'Regole CSS che saranno aggiunte in tutte le pagine, facilitando la personalizzazione del tema.';
$string['pluginname'] = 'Anomaly';
$string['region-side-post'] = 'Destra';
$string['region-side-pre'] = 'Sinistra';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'Il testo inserito come tagline comparirà solamente sotto l\'intestazione della home page del sito';
