...
/**
 * Strings for component 'theme_splash', language 'it', branch 'MOODLE_30_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni Splash';
...
$string['hide_tagline'] = 'Nascondi tagline';
$string['hide_taglinedesc'] = 'Nasconde il tagline sotto il logo';
$string['loginhere'] = 'Effettua il login qui!';
$string['logo'] = 'Logo';
$string['logodesc'] = 'E\' possibile inserire l\'URL di una immagine per personalizzare il logo, ad esempio http://www.yoursite.com/path/to/logo.png. Il logo può avere una larghezza massima di 230 pixel.';
$string['pluginname'] = 'Splash';
$string['region-side-post'] = 'Destra';
$string['region-side-pre'] = 'Sinistra';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'Il testo inserito sarà visualizzato sotto il logo del sito nella pagina home';
$string['usergreeting'] = 'Ciao {$a}!';
