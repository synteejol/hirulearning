...
/**
 * Strings for component 'error', language 'it', branch 'MOODLE_39_STABLE'
 *
 * @package   error
...
$string['movecatcontentstoselected'] = 'Non è possibile spostare alcune categorie all\'interno della categoria selezionata.';
