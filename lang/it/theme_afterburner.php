...
/**
 * Strings for component 'theme_afterburner', language 'it', branch 'MOODLE_31_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni personalizzate Afterburner';
$string['customcss'] = 'CSS personalizzato';
$string['customcssdesc'] = 'Le regole CSS inserite in questa area di testo avranno influenza su tutte le pagine, rendendo più semplice la personalizzazione del tema.';
$string['footnote'] = 'Piè di pagina';
$string['footnotedesc'] = 'Il testo inserito comparirà in tutti i piè di pagina.';
$string['logo'] = 'Logo';
$string['logodesc'] = 'Aggiungi l\'URL del logo solo se desideri cambiare il logo di default usato da questo tema.<br />Il logo di default è una immagine JPG larga 320 pixel ed alta 75 pixel.';
