...
/**
 * Strings for component 'theme_overlay', language 'it', branch 'MOODLE_31_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni Overlay';
...
$string['footertext'] = 'Piè di pagina';
$string['footertextdesc'] = 'Testo del piè di pagina';
$string['headercolor'] = 'Colore intestazione';
$string['headercolordesc'] = 'Il colore dello sfondo dell\'intestazione';
$string['linkcolor'] = 'Colore link';
$string['linkcolordesc'] = 'Imposta il colore dei link';
$string['pluginname'] = 'Overlay';
$string['region-side-post'] = 'Destra';
$string['region-side-pre'] = 'Siistra';
