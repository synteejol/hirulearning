...
/**
 * Strings for component 'role', language 'it', branch 'MOODLE_39_STABLE'
 *
 * @package   role
...
$string['contentbank:access'] = 'Accedi al deposito dei contenuti';
$string['contentbank:upload'] = 'Carica contenuti nel deposito';
