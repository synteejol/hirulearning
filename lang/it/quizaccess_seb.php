...
/**
 * Strings for component 'quizaccess_seb', language 'it', branch 'MOODLE_39_STABLE'
 *
...
$string['event:accessprevented'] = 'L\'accesso al quiz è stato impedito';
$string['event:templatecreated'] = 'Creato modello SEB';
$string['event:templatedeleted'] = 'Eliminato modello SEB';
$string['event:templatedisabled'] = 'Disabilitato modello SEB';
$string['event:templateenabled'] = 'Abilitato modello SEB';
$string['event:templateupdated'] = 'Aggiornato modello SEB';
...
$string['invalidkeys'] = 'Non è stato possibile convalidare la chiave di configurazione o la chiave del browser. Accertarsi di utilzzare Safe Exam Browser con l\'appropriato file di configurazione.';
...
$string['seb_allowedbrowserexamkeys'] = 'Chiavi browser consentite per svolgere l\'esame';
$string['seb_allowedbrowserexamkeys_help'] = 'E\' possibile inserire le Chiavi browser consentite per svolgere l\'esame per le versioni di Safe Exam Browser che consentono l\'accesso al quiz. Se non verranno inserite chiavi, Moodle non controllerà chiavi degli esami.';
...
$string['seb_linkquitseb_help'] = 'Consente di inserire il link per uscire da SEB. Verrà utilizzato per il pulsante "Esci da Safe Exam Browser" nella pagina che appare dopo che l\'esame sarà stato inviato. Quando si clicca il pulsante o il link messo dove si desidera, sarà possibile uscire da SEB senza dover inserire la password di uscita. Se non viene inserito un link, allora il pulsante "Esci da Safe Exam Browser" non apparirà e non ci sarà un link impostato per uscire da SEB.';
...
$string['seb_templateid_help'] = 'Consente di utilizzare le impostazioni contenute nel modello durante lo svolgimento del quiz tramite Safe Exam Browser. E\' possibile modificare le impostazioni del modello con impostazioni manuali.';
