...
/**
 * Strings for component 'block_panopto', language 'it', branch 'MOODLE_39_STABLE'
 *
...
$string['attribute_new_name'] = 'Nome della cartella';
...
$string['block_global_build_category_structure'] = 'Sincronizza le categorie Moodle su Panopto';
...
$string['block_panopto_auto_provision_desc'] = 'Abilitare l\'opzione per eseguire automaticamente il provisioning di una cartella corso Panopto all\'atto della creazione di un corso in Moodle.';
$string['block_panopto_auto_sync_imports'] = 'Concedi automaticamente i privilegi durante l\'importazione di un corso';
...
$string['bulk_rename_start_button'] = 'Inizia a rinominare le cartelle';
$string['bulk_rename_start_renaming'] = 'Inizia ad aggiornare tutti i nomi delle cartelle';
$string['bulk_reprovision_start'] = 'Aggiornamento di tutte le cartelle di panopto';
$string['bulk_reprovision_start_button'] = 'Inizia ad aggiornare le cartelle';
$string['bulk_task_new_step'] = 'Inizia lo step: {$a}';
$string['bulk_task_reached_count'] = 'E\' stato raggiunto il numero di cartelle desiderato, inizia il passaggio successivo';
$string['cli_heading_build_category_structure'] = 'Sincronizzazione di tutte le categorie Moodle su Panopto';
...
$string['download_recorder'] = 'Scarica il recorder';
$string['error_invalid_category_information'] = 'La categoria di destinazione non contiene informazioni valide.';
$string['existing_course'] = 'Seleziona una cartella Panopto esistente che non sia già mappata su un altro corso:';
...
$string['import_success'] = 'Corso importato correttamente';
...
$string['no_completed_recordings'] = 'Non ci sono registrazioni completate';
$string['no_course_selected'] = 'Non è stata selezionata nessuna cartella Panopto';
$string['no_creators'] = 'Non ci sono creatori.';
$string['no_folder_associated_with_moodle_id'] = 'Non ci sono cartelle Panopto associate al corso Moodle con Id {$a}';
$string['no_live_sessions'] = 'Nessuna sessione live';
$string['no_viewers'] = 'Non ci sono spettatori.';
$string['panopto:addinstance'] = 'Aggiungere blocco Panopto';
$string['panopto:myaddinstance'] = 'Aggiungere blocco Panopto alla dashboard';
$string['result'] = 'Risultati';
$string['show_all'] = 'Visualizza tutto';
$string['show_less'] = 'Visualizza meno';
$string['take_notes'] = 'Scrivi note';
$string['unknown_provisioning_error'] = 'Si è verificato un errore sconosciuto.';
$string['viewers'] = 'Spettatori';
