...
/**
 * Strings for component 'theme_arialist', language 'it', branch 'MOODLE_32_STABLE'
 *
...
$string['configtitle'] = 'Impostazioni Arialist';
$string['customcss'] = 'CSS personalizzati';
...
$string['linkcolordesc'] = 'Imposta il colore dei link usato dal tema.';
$string['logo'] = 'Logo';
$string['logodesc'] = 'E\' possibile inserire l\'URL di una immagine per personalizzare il logo, ad esempio http://www.yoursite.com/path/to/logo.png. L\'altezza consigliata è di 100 pixel.';
$string['pluginname'] = 'Arialist';
$string['region-side-post'] = 'Destra';
$string['region-side-pre'] = 'Sinistra';
$string['regionwidth'] = 'Larghezza colonna';
$string['regionwidthdesc'] = 'Imposta la larghezza delle regioni laterali destra e sinistra dove appaiono i blocchi.';
$string['tagline'] = 'Tagline';
$string['taglinedesc'] = 'Una breve tagline da visualizzare nella pagina home sotto al nome del sito. <br /><em>(Non compare in presenza di un logo)</em>';
